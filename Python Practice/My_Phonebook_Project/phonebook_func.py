        ...
        with conn:
            cursor = conn.cursor()(
                ...
                if chkName == 0:
                    ...
                    cursor.execute("""INSERT INTO tbl_phonebook (col_fname, col_lname, col_fullname, col_phone, col_email) VALUES (?, ?, ?, ?, ?)""", (var_fname, var_lname, var_fullname,_var_phone, var_email))
